            ...
            <nav className="navbar bg-text-white dark:bg-black max-w-7xl mx-auto dark:text-white">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu dark:bg-slate-400 menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                            {NavLinks}
                        </ul>
                    </div>
                    <div onClick={handleGoHome} className=" cursor-pointer flex items-center">
                        <img width="100" className="-mt-2 -ml-4 md:-mt-1" src='https://i.ibb.co/55TkSkX/simple-eagle-wing-logo-symbol-free-vector.png' alt="" />
                        <span className="text-2xl md:text-3xl -ml-2 md:mt-2 font-bold">B<span className="text-red-500">M</span>B</span>
                    </div>
                ...
                <div className="navbar-end">
                    <p className="mr-3 hidden md:block">{user?.displayName ? user.displayName : "VISITOR"}</p>
